...
Great, now perform a few adjustments: (a) Log transform the Y-axis so that low abundances are visible (I use `log_epsilon_trans`), (b) divide into to facets to show phylum level, (b) expand the plot to include relative abundance of 100%, (c) rotate and left-justify the X-axis labels. 
